...
public class ItemCategoryBindingImpl extends ItemCategoryBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.category == variableId) {
            setCategory((com.example.basemvvm.data.model.Category) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setCategory(@Nullable com.example.basemvvm.data.model.Category Category) {
    ...
    protected void executeBindings() {
        ...
        com.example.basemvvm.data.model.Category category = mCategory;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tvCategory, categoryName);
        }
    }
